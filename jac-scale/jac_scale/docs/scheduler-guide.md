...
system_account_password = "__no_password__"  # default, password for the internal __system__ user
```
...
| `system_account_password` | str | `"__no_password__"` | Password for the internal `__system__` user account used by the scheduler to execute walkers. Override this in production with a secure value. |
